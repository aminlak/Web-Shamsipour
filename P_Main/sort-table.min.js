...
function sortTable(a, b, c) {
    ...
    sortTable.sortFunc = null != d ? d[0].replace(/js-sort-/,
        "") : "string";
    a.querySelectorAll(".js-sort-active").forEach(function(a) { a.className = a.className.replace(/ ?js-sort-active\b/, "") });
    a.querySelectorAll('[data-js-sort-colNum="' + b + '"]:not(:empty)').forEach(function(a) { a.className += " js-sort-active" });
    b = [];
    a = a.tBodies[0];
    for (c = 0; c < a.rows.length; c++) b[c] = a.rows[c];
    for (b.sort(sortTable.compareRow); a.firstChild;) a.removeChild(a.firstChild);
...
sortTable.date = function(a) { return new Date(sortTable.stripTags(a.innerHTML)) };
...
sortTable.init = function() {
    ...
    c = c.sheet;
    c.insertRule('table.js-sort-asc thead tr > .js-sort-active:after{content:"\\25b2";font-size:0.7em;padding-left:3px;line-height:0.7em;}');
    c.insertRule('table.js-sort-desc thead tr > .js-sort-active:after{content:"\\25bc";font-size:0.7em;padding-left:3px;line-height:0.7em;}')
};
